<img src="https://i.ibb.co/kx08h9q/final-product.png" alt="final-product" border="0">
...
```html
<script src="https://unpkg.com/@rocktimsaikia/github-card@1.2.0/dist/widget.min.js" type="module"></script>
```
